...
/**
 * ZhumuSDKInviteHelper is class which used to get/set some settings in meeting.
 */
@interface ZhumuSDKInviteHelper : NSObject
...
/**
 * Returns the instance of ZhumuSDKInviteHelper
 */
+ (ZhumuSDKInviteHelper*)sharedInstance;
