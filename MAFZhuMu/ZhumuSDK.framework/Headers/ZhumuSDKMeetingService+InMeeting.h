//
//  ZhumuSDKMeetingService+InMeeting.h
//  ZhumuSDK
//
 ...
 *
 */
@interface ZhumuSDKMeetingService (InMeeting)
 ...
 *
 * @return user info, a ZhumuSDKMeetingUserInfo object.
 */
- (ZhumuSDKMeetingUserInfo*)userInfoByID:(NSUInteger)userId;
